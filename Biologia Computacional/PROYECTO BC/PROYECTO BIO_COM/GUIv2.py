...
especies={'Iridosornis reinhardti':'gene_Iridosornis_reinhardti.fasta',
'Sicalis raimondii':'gene_Sicalis_raimondii.fasta',
'Poospiza caesar':'gene_Poospiza_caesar.fasta',
'Poospiza rubecula':'gene_Poospiza_rubecula.fasta',
'Poospiza alticola':'gene_Poospiza_alticola.fasta',
'Incaspiza ortizi':'gene_Incaspiza_ortizi.fasta',
'Incaspiza personata':'gene_Incaspiza_personata.fasta',
'Incaspiza pulchra':'gene_Incaspiza_pulchra.fasta',
'Piezorhina cinerea':'gene_Piezorhina_cinerea.fasta',
'Tangara phillipsi':'gene_Tangara_phillipsi.fasta'}
...
'Tangara phillipsi':'Tangara_phillipsi.txt'}
        self.ventana1=tk.Tk()
        self.ventana1.title("Análisis de la proteína CYTOCHROME B en aves endémicas del Perú")
        self.cuaderno1 = ttk.Notebook(self.ventana1)
        
        self.pagina1 = ttk.Frame(self.cuaderno1)
        self.cuaderno1.add(self.pagina1, text="Align")
        ...
        self.boton1=ttk.Button(self.pagina1, text="UPGMA TREE",command=self.upgma)
        self.boton1.grid(column=3, row=5)
        self.boton1=ttk.Button(self.pagina1, text="NJ TREE",command=self.njt)
        self.boton1.grid(column=5, row=5)
        ...
        self.scrolledtext2.grid(column=1,row=0,rowspan=7,columnspan=7)
        self.scrolledtext2.insert(tk.INSERT,output2)
        self.scrolledtext2.config(state=tk.DISABLED)

        self.pagina2 = ttk.Frame(self.cuaderno1)
        self.cuaderno1.add(self.pagina2, text="Info")
    ...
    def alinear(self):
        os.system("muscle -in fastaselec.fasta -out musculo.fasta -quiet")
        output = leerg.sel_fasta("musculo.fasta")
        self.scrolledtext2.config(state=tk.NORMAL) 
        self.scrolledtext2.delete("1.0",tk.END)
    ...
    def upgma(self):
        leerg.upgma_tree("musculo.fasta")
    
    def njt(self):
        leerg.nj_tree("musculo.fasta")
        
aplicacion1=Aplicacion()
aplicacion1.fastalist.close()
os.system("rm fastaselec.fasta musculo.fasta")
