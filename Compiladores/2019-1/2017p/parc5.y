...
%token MAS MENOS POR ENTRE IGUAL POW SENO
...
atributo: permiso ID IGUAL nivel1 PUNTOYCOMA
	...
	| permiso asign PUNTOYCOMA;

primera_linea_metodo: permiso INICIO_METODO asign ABRE_PARENTESIS declaracion CIERRA_PARENTESIS  contenido FIN_METODO
   | permiso INICIO_METODO asign ABRE_PARENTESIS CIERRA_PARENTESIS  contenido FIN_METODO
   | permiso INICIO_METODO asign ABRE_PARENTESIS declaracion CIERRA_PARENTESIS  contenido RETURN nivel1 PUNTOYCOMA FIN_METODO
   | permiso INICIO_METODO asign ABRE_PARENTESIS CIERRA_PARENTESIS  contenido RETURN nivel1 PUNTOYCOMA FIN_METODO;
...
contenido_objeto: asign IGUAL NUEVO ID ABRE_PARENTESIS parametros_bloq CIERRA_PARENTESIS PUNTOYCOMA
	| asign IGUAL NUEVO ID ABRE_PARENTESIS CIERRA_PARENTESIS PUNTOYCOMA;
...
contenido_metodo_main: asign ABRE_PARENTESIS parametros_bloq CIERRA_PARENTESIS PUNTOYCOMA
   | asign ABRE_PARENTESIS CIERRA_PARENTESIS PUNTOYCOMA
   | asign IGUAL ID ABRE_PARENTESIS parametros_bloq CIERRA_PARENTESIS PUNTOYCOMA
   | asign IGUAL ID ABRE_PARENTESIS CIERRA_PARENTESIS PUNTOYCOMA;
...
nivel3: nivel3 POR nivel4
   | nivel3 ENTRE nivel4       
   | nivel3 POW nivel4
   | SENO ABRE_PARENTESIS nivel4 CIERRA_PARENTESIS
   | nivel4;
...
int palabras_lenguaje( char lexema[] ) {
	...
	if( strcmp(lexema, "seno")==0) return SENO;		
	return ID;
}
