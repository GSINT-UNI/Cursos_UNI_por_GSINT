...
estructura: estructura expresion | ;

expresion: MAS expresion expresion | MENOS expresion expresion | producto ;

producto: MUL expresion expresion | DIV expresion expresion | valor ;
