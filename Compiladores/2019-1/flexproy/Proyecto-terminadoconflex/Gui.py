...
class Gui(QMainWindow):
	def __init__(self):
		super().__init__()
		self.setWindowTitle('Compialdor proy final');
...
class ToolBar(QWidget):
	...
	def run(self):# ---------------------
		...
		yacc_path = "./compilers/"+"final.y"
		lex_path = "./compilers/"+"lex.l"
		
		command1 = "bison -v -d" + yacc_path + " -o ./compilers/" + "final.tab.c"
		
		command2 = "gcc ./compilers/final.tab.c -w -lm -o ./compilers/compiler"
		os.system("bison -v -d ./compilers/final.y -o ./compilers/final.tab.c" + " && " + " flex -o ./compilers/lex.yy.c ./compilers/lex.l " + " && " + "sudo cc ./compilers/lex.yy.c ./compilers/final.tab.c -w -o ./compilers/compiler -lfl -lm ")
		
		os.system('./compilers/compiler < input.temp > output.temp')
