...
imprimir: IMPRIMIR level1 {generaCodigo(IMPRIMIR,$2,'-','-');}| IMPRIMIR COMILLA MENSAJE1 MENSAJE2 MENSAJE3 COMILLA{generaCodigo(IMPRIMIR,$2,'-','-');}{printf("No hay suma\n");};
...
instruccion: SUMA DESDE ID HASTA ID {bucleF=cx; }{generaCodigo(SALTARF3,$3,$5,'-');$5=cx;} bloque {generaCodigo(BUCLE,bucleF,'-','-');}{TCodigo[$8].a3=cx;}{TCodigo[$10].a1=cx+1;};
