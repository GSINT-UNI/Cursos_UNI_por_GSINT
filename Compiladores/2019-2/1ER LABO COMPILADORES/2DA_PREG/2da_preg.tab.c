...
{
  "$end", "error", "$undefined", "ID", "NUM", "COMA", "'['", "']'", "'='",
  "'+'", "$accept", "raiz", "expresion", "termino", "factor", YY_NULLPTR
};
#endif
...
{
       0,   256,   257,   258,   259,   260,    91,    93,    61,    43
};
# endif
...
{
       5,    12,     8,     9,     6,    13,     1,     4,    14,     7
};

static const yytype_uint8 yycheck[] =
{
       3,     5,     3,     4,     7,     9,     6,     0,    13,     8
};
