...
{
       0,    54,    54,    56,    56,    56,    56,    56,    56,    59,
      59,    59,    59,    60,    60,    62,    63,    64,    65,    66,
      67,    69,    69,    69,    72,    72,    72,    73,    74,    75,
      76,    77,    78,    80,    81,    83,    83,    83,    87,    87,
...
static const char *const yytname[] =
{
  ...
  "SALTARF4", "WHILE", "MIENTRAS", "';'", "'.'", "'('", "')'", "'{'",
  "'}'", "'>'", "'<'", "'='", "':'", "'+'", "'-'", "'*'", "'/'", "$accept",
  "s", "listaInstr", "bloque_if", "@1", "@2", "$@3", "otro", "condicion",
  "imprimir", "$@4", "$@5", "asignacion", "@6", "$@7", "expr", "term",
  "fact", "number", "bucle_for", "$@8", "@9", "@10", "$@11", "bucle_while",
  "@12", "@13", "$@14", YY_NULLPTR
};
#endif
...
static const yytype_uint16 yytoknum[] =
{
     ...
     285,   286,   287,   288,   289,   290,   291,    59,    46,    40,
      41,   123,   125,    62,    60,    61,    58,    43,    45,    42,
      47
};
# endif
...
{
       8,     0,    20,   -12,   -32,    22,    54,     5,   -32,    -4,
       3,     2,    30,    54,    54,    54,    54,    54,   -32,   -32,
      33,    48,     9,     3,     3,   -19,   -18,   -32,   -32,     3,
      16,   -32,   -32,   -32,   -32,   -32,   -32,     5,    13,    24,
     -21,   -31,     3,     3,   -32,     3,     3,    27,   -32,    63,
       3,   -32,    11,     1,    28,   -32,   -18,   -18,    32,   -32,
     -32,    69,   -32,   -19,    50,     3,   -19,     3,     3,   -19,
       3,   -32,   -32,   -32,    39,    36,   -19,   -19,   -19,   -19,
      37,    38,   -32,    54,    54,    54,    41,    42,    43,   -32,
     -32,   -32,   -32,   -32,   -32,    67,   -32,   -32,    40,   -32,
      54,    44,   -32
};
...
{
       0,     0,     0,     0,     1,     0,     8,     0,    24,     0,
       0,     0,     0,     8,     8,     8,     8,     8,    36,    35,
       0,     0,     0,     0,     0,    21,    29,    32,    34,     0,
       0,     5,     7,     4,     6,     3,    37,     0,     0,     0,
       0,     0,     0,     0,    22,     0,     0,     0,     2,     0,
       0,     9,     0,     0,     0,    33,    27,    28,     0,    30,
      31,     0,    38,    25,     0,     0,    15,     0,     0,    16,
       0,    23,    43,    39,     0,     0,    19,    18,    20,    17,
       0,     0,    26,     8,     8,     8,     0,     0,     0,    10,
      44,    40,    11,    45,    41,    14,    46,    42,     0,    12,
       8,     0,    13
};
...
{
     -32,   -32,   -13,   -32,   -32,   -32,   -32,   -32,    59,   -32,
     -32,   -32,   -32,   -32,   -32,    -5,    -9,    -8,    -1,   -32,
...
{
      -1,     2,    12,    13,    64,    92,    95,    99,    39,    14,
      44,    58,    15,    22,    74,    40,    26,    27,    28,    16,
      73,    81,    94,    97,    17,    80,    93,    96
};
...
{
      31,    32,    33,    34,    35,    25,    21,     3,    18,    55,
      18,    19,    18,    19,     1,    19,    42,    43,    18,    41,
       4,    19,    52,    53,    54,     5,    42,    43,    42,    43,
       6,    45,    46,    56,    57,    23,    49,    59,    60,    30,
      24,    29,    24,    36,    67,    63,    68,    66,    69,    20,
      24,    20,    37,    20,    48,    38,    65,     7,    50,    20,
      76,     8,    77,    78,    51,    79,     9,    61,    62,    71,
      86,    87,    88,    70,    72,    75,    82,    83,    84,    85,
      98,   100,    10,    89,    90,    91,   102,   101,    47,     0,
      11
};

static const yytype_int8 yycheck[] =
{
      13,    14,    15,    16,    17,    10,     7,     7,     7,    40,
       7,    10,     7,    10,     6,    10,    47,    48,     7,    24,
       0,    10,    43,    44,    45,    37,    47,    48,    47,    48,
       8,    49,    50,    42,    43,    39,    37,    45,    46,     9,
      39,    39,    39,    10,    43,    50,    45,    52,    53,    48,
      39,    48,     4,    48,    38,    46,    45,     3,    45,    48,
      65,     7,    67,    68,    40,    70,    12,    40,     5,    37,
      83,    84,    85,    45,     5,    25,    37,    41,    41,    41,
      13,    41,    28,    42,    42,    42,    42,   100,    29,    -1,
      36
};
...
{
       0,     6,    52,     7,     0,    37,     8,     3,     7,    12,
      28,    36,    53,    54,    60,    63,    70,    75,     7,    10,
      48,    69,    64,    39,    39,    66,    67,    68,    69,    39,
       9,    53,    53,    53,    53,    53,    10,     4,    46,    59,
      66,    66,    47,    48,    61,    49,    50,    59,    38,    69,
      45,    40,    43,    44,    45,    40,    67,    67,    62,    68,
      68,    40,     5,    66,    55,    45,    66,    43,    45,    66,
      45,    37,     5,    71,    65,    25,    66,    66,    66,    66,
      76,    72,    37,    41,    41,    41,    53,    53,    53,    42,
      42,    42,    56,    77,    73,    57,    78,    74,    13,    58,
      41,    53,    42
};
...
{
       0,    51,    52,    53,    53,    53,    53,    53,    53,    55,
      56,    57,    54,    58,    58,    59,    59,    59,    59,    59,
      59,    61,    62,    60,    64,    65,    63,    66,    66,    66,
      67,    67,    67,    68,    68,    69,    69,    69,    71,    72,
      73,    74,    70,    76,    77,    78,    75
};
...
#line 1476 "tabla.tab.c"
    break;

  case 38:
#line 87 "tabla.y"
    {bucleF=100;}
#line 1482 "tabla.tab.c"
    break;

  case 39:
#line 87 "tabla.y"
    {generarCodigo(SALTARF3,yyvsp[-4],yyvsp[-2],'-');posicion_for=cx;yyval=cx;}
#line 1488 "tabla.tab.c"
    break;

  case 40:
#line 87 "tabla.y"
    {generarCodigo(BUCLE,'?','-','-');yyval=cx;}
#line 1494 "tabla.tab.c"
    break;

  case 41:
#line 87 "tabla.y"
    {TCodigo[yyvsp[-4]].a3=cx;}
#line 1500 "tabla.tab.c"
    break;

  case 42:
#line 87 "tabla.y"
    {printf("$11 es %d \n",yyvsp[-1]);TCodigo[yyvsp[-1]].a1=cx+1;TCodigo[yyvsp[-1]].a2=posicion_for;}
#line 1506 "tabla.tab.c"
    break;

  case 43:
#line 89 "tabla.y"
    {generarCodigo(SALTARF4,yyvsp[-2],'-','-');posicion_while=cx;yyval=cx;}
#line 1512 "tabla.tab.c"
    break;

  case 44:
#line 89 "tabla.y"
    {generarCodigo(WHILE,'?','-','-');yyval=cx;}
#line 1518 "tabla.tab.c"
    break;

  case 45:
#line 89 "tabla.y"
    {printf("$6 es %d TCodigo[$6].a2 sera %d\n",yyvsp[-4],cx);TCodigo[yyvsp[-4]].a2=cx;}
#line 1524 "tabla.tab.c"
    break;

  case 46:
#line 89 "tabla.y"
    {printf("$10 es %d , TCodigo[$10].a1 sera %d \n",yyvsp[-1],cx+1);TCodigo[yyvsp[-1]].a1=cx+1;TCodigo[yyvsp[-1]].a2=posicion_while;}
#line 1530 "tabla.tab.c"
    break;


#line 1534 "tabla.tab.c"
...
void actualiza(){
    ...
    if(op==IGUAL){
		...
		if(op==SALTARF4){
			printf("Entrando a while, activandolo.......\n");
			while_activado=1;
			if(TablaSim[a1].valor==0){printf("Desactivando while...."); while_activado=0;i = a2-1;}
		}
		if(op==WHILE){
			printf("Viendo si salgo del while.......\n");
			if(while_activado){
				printf("While activado\n");
				i = a2-2;
			}
