...
%token ID NUM POT RAIZ SI SINO MIENTRAS END ASCII UNION INTERSECCION TIPO PARA DESDE HASTA PUNTCOM
...
ifelse: SI '(' list_cond ')' ':' estructura END 
   SINO ':' estructura END 
...
comen: comen ID | comen SI | comen ',' | comen SINO | comen PARA | comen MIENTRAS | comen ':' |comen RAIZ | comen POT | ;
