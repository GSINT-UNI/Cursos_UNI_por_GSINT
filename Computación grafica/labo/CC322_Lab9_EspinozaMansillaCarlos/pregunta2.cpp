...
// Window/viewport
const int startwinsize = 900;  // Start window width & height (pixels)
...
// Object: variables para la linea 1
...
bool drawverts=true;                // True if control points drawn

// Object: variables para la linea 2 
vector<vector<GLdouble> > verts2;
bool drawverts2=true;                // True if control points drawn

// Object: variables para la linea 3
vector<vector<GLdouble> > verts3;
bool drawverts3=true;                // True if control points drawn
...
void myDisplay()
{
    ...
    p.print("Para cambiar de curva presione a,s o d");
    p.print("Esc     Quit");
...
void myKeyboard(unsigned char key, int x, int y)
{
    ...
    case 'C':
        ...
        glutPostRedisplay();
        break;
    case 'a':     //cambio a linea 1 
    case 'A':
        indicador = 1;
        glutPostRedisplay();
        break;
    case 's':     //cambio a linea 2 
    case 'S':
        indicador = 2;
        glutPostRedisplay();
        break;
    case 'd':     //cambio a linea 3 
    case 'D':
        indicador = 3;
        glutPostRedisplay();
        break;    
    case ' ':     // Space: delete last control pt
        if (verts.size() > 0 && indicador==1)
        {
            verts.pop_back();
            selectedvert = -1;
