...
def DrawGLScene():
  ...
  while x == 1 :
       ...
       glRotatef(angle,0.0,1.0,0.0)        # Rota el triangulo
       ...
       glLoadIdentity()               # Reset The View 
       # Move from Center to Right 1.5 units and into the screen 6.0 units.
       glTranslatef(1.5, 0.0, -6.0)
       glRotatef(angle,1.0,0.0,0.0)        #Rota el cuadrado
