...
def InitGL(Width, Height):  # We call this right after our OpenGL window is created.
    ...
    LoadTexture('mirrow2.bmp')#se cambio la textura a 
    glEnable(GL_TEXTURE_2D)

    glActiveTexture(GL_TEXTURE1)
    LoadTexture('tucancito.bmp')#le cambie la textura a tucancito
    glEnable(GL_TEXTURE_2D)
...
def DrawGLScene():
    ...
    glTexEnvfv(GL_TEXTURE_ENV, GL_TEXTURE_ENV_COLOR, (1,1,1, 1)) #le cambie el vector que cambia el color para que este fijo en un estado
