...
def draw():
    ...
    glCallList(gear1) #Llama  a la lista de comandos
    glPopMatrix()

    glPushMatrix()
    glTranslatef(3.1, -2.0, 0.0)
    glRotatef(-2.0*angle-9.0, 0.0, 0.0, 1.0)
    glCallList(gear2) #Llama  a la lista de comandos
    glPopMatrix()
...
def init():
    ...
    # Hacerl las Ruedas Dentadas - Crea una lista de comandos OpenGl
    gear1 = glGenLists(1)
...
if __name__ == '__main__':
    ...
    glutCreateWindow("Practica Calificada 1")
    init()
