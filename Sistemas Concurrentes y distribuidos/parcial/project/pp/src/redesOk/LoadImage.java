...
public class LoadImage {
   /* public static void main(String args[]) {
        int[][] myImg = getMatrixOfImage("H:\\8vo Ciclo\\Concurrentes\\parcial\\project\\pp\\src\\redesOk\\test3.jpg");
       ...
       // for(int i = 0; i < myImg.length; i++) {
        ...
        saveImageFromMatrix(myImgGS, "H:\\\\8vo Ciclo\\\\Concurrentes\\\\parcial\\\\project\\\\pp\\\\src\\\\redesOk\\\\pepito3.jpg");
