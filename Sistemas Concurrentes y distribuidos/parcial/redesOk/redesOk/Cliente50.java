...
class Cliente50 {
    ...
    void iniciar() {
        new Thread(
            ...
            @Override
            public void run() {
                mTcpClient = new TCPClient50("192.168.10.26",
    ...
    public class tarea0101 extends Thread {
        ...
        public void run() {
        String[] pathnames;
        File f = new File("/home/gusfraba/Música");
        int[][] myImg;
        int[][] myImgGS;
        // Populates the array with names of files and directories
        pathnames = f.list();
        for(int i = min; i<=max ; i++){
            myImg = LoadImage.getMatrixOfImage("/home/gusfraba/Música/"+pathnames[i-1]);
            myImgGS = LoadImage.toGrayScale(myImg, false);
            LoadImage.saveImageFromMatrix(myImgGS,"/home/gusfraba/Música/"+pathnames[i-1]+"_converted.jpg");
            }
