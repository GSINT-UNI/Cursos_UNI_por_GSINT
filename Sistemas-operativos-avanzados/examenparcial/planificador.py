...
print('Arguments policy', options.policy)
if options.jlist == '':
    print('Arguments jobs', options.jobs)
    print('Arguments maxlen', options.maxlen)
    print('Arguments seed', options.seed)
else:
    print('Arguments jlist', options.jlist)
print('')
...
if options.solve == True:
    ...
    if options.policy == 'FIFO':
        ...
        for job in joblist:
            print('[Time %2d ] Run job %d for %.2f secs ( DONE at %.2f )' % (thetime, job[0], job[1], thetime + job[1]))
            thetime += job[1]
