...
print('Argument jlist', options.jlist)
print('Argument jobs', options.jobs)
print('Argument maxlen', options.maxlen)
print('Argument maxticket', options.maxticket)
print('Argument quantum', options.quantum)
...
if options.solve == True:
    ...
    for i in range(runTotal):
        ...
        # Job finished
        if wrun == 0:
            print('--> Trabajo %d DONE at time%d' % (wjob, clock))
            tickTotal -= wtix
            wtix = 0
            jobs -= 1
