...
class scheduler:
    def __init__(self, job_list, per_cpu_queues, affinity, peek_interval,
        ...
        print('Job name\trun_time\tworking_set_size')
        for entry in job_list.split(','):
            ...
            print('%s\t\t%d\t\t%d' % (job_name, run_time, working_set_size))
...
print('Arguments seed %s' % options.seed)
print('Arguments job_num %s' % options.job_num)
print('Arguments max_run %s' % options.max_run)
print('Arguments max_wset %s' % options.max_wset)
print('Arguments job_list %s' % options.job_list)
print('Arguments affinity %s' % options.affinity)
print('Arguments per_cpu_queues %s' % options.per_cpu_queues)
print('Arguments num_cpus %s' % options.num_cpus)
print('Arguments quantum %s' % options.time_slice)
print('Arguments peek_interval %s' % options.peek_interval)
print('Arguments warmup_time %s' % options.warmup_time)
print('Arguments cache_size %s' % options.cache_size)
print('Arguments random_order %s' % options.random_order)
print('Arguments trace %s' % options.trace)
print('Arguments trace_time %s' % options.trace_time_left)
print('Arguments trace_cache %s' % options.trace_cache)
print('Arguments trace_sched %s' % options.trace_sched)
print('Arguments compute %s' % options.solve)
print('')
