...
print('Argument numthreads',          options.numthreads)
print('Argument program',             options.progfile)
print('Argument interrupt frequency', options.intfreq)
print('Argument interrupt randomness',options.intrand)
print('Argument procsched',           options.procsched)
print('Argument argv',                options.argv)
print('Argument load address',        options.loadaddr)
print('Argument memsize',             options.memsize)
print('Argument memtrace',            options.memtrace)
print('Argument regtrace',            options.regtrace)
print('Argument cctrace',             options.cctrace)
print('Argument printstats',          options.printstats)
