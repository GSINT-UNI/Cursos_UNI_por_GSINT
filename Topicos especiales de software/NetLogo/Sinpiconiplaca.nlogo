...
to setup
  ...
  ;set lanes-truck remove-first-n  lanes 2
  ;set lanes sublist lanes 2 (length lanes)
...
to dar-paso
  let lista-obstaculos other turtles in-cone 3 180 with [ y-distance = 0]
  let obstaculo min-one-of lista-obstaculos [ distance myself ]
  if obstaculo != nobody [
      ask obstaculo [ set patience 0 ]
