...
class App:
	...
	def capital(self):			
		self.tubo.agregarfiltro(Capitalizar)
	
	def voltear(self):			
		self.tubo.agregarfiltro(Reverse)

	def quitar_espacio(self):
		self.tubo.agregarfiltro(FiltrarEspacio)			
		
	def dolarasol(self):
		self.tubo.agregarfiltro(DolaraSoles)		
		
	def soladolar(self):
		self.tubo.agregarfiltro(SolesaDolares)
	
	def contar(self):
		self.tubo.agregarfiltro(CuentaPalabras)	

	def desordenar(self):
		self.tubo.agregarfiltro(DesordenarCodigo)	
